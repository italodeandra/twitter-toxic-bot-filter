...
const Privacy = () => {
    return (
      <Container maxWidth="md" disableGutters><Box p={3} style={{textAlign: 'justify'}}>
          ...
          <p>At Twitter Toxic-bot Filter, accessible from https://twitter-toxic-bot-filter.italodeandra.de, one of our
              main priorities is the privacy of our visitors. This Privacy Policy document contains types of information
              that is collected and recorded by Twitter Toxic-bot Filter and how we use it.</p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
              regards to the information that they shared and/or collect in Twitter Toxic-bot Filter. This policy is not
          ...
          <ul>
              ...
              <li>Communicate with you, either directly or through one of our partners, including for customer service,
                  to provide you with updates and other information relating to the webste, and for marketing and
          ...
          <p>Twitter Toxic-bot Filter follows a standard procedure of using log files. These files log visitors when
              ...
              demographic information. Our Privacy Policy was created with the help of the <Link
                href="https://www.privacypolicygenerator.info">Privacy Policy Generator</Link> and the <Link
                href="https://www.privacypolicytemplate.net/">Privacy Policy Template</Link>.</p>

          <h2>Cookies and Web Beacons</h2>

          <p>Like any other website, Twitter Toxic-bot Filter uses 'cookies'. These cookies are used to store
          ...
          <p>For more general information on cookies, please read <Link
            href="https://www.cookieconsent.com/what-are-cookies/">"What Are Cookies"</Link>.</p>
          ...
          <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve
              ...
              network Privacy Policy at the following URL – <Link
                href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</Link></p>

          <h2>Advertising Partners Privacy Policies</h2>

          <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Twitter
              Toxic-bot Filter.</p>

          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
              used in their respective advertisements and links that appear on Twitter Toxic-bot Filter, which are sent
          ...
          <p>Note that Twitter Toxic-bot Filter has no access to or control over these cookies that are used by
              third-party advertisers.</p>

          <h2>Third Party Privacy Policies</h2>

          <p>Twitter Toxic-bot Filter's Privacy Policy does not apply to other advertisers or websites. Thus, we are
          ...
          <p>Twitter Toxic-bot Filter does not knowingly collect any Personal Identifiable Information from children
