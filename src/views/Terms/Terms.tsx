...
const Terms = () => {
    return (
      <Container maxWidth="md" disableGutters><Box p={3} style={{textAlign: 'justify'}}>
          <h2><strong>Terms of service</strong></h2>

          <p>Welcome to Twitter Toxic-bot Filter!</p>

          <p>These terms and conditions outline the rules and regulations for the use of Ítalo Andrade's Website,
              located at https://twitter-toxic-bot-filter.italodeandra.de.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Twitter
              Toxic-bot Filter if you do not agree to take all of the terms and conditions stated on this page. Our
              Terms and Conditions were created with the help of the <Link
                href="https://www.termsandconditionsgenerator.com">Terms And Conditions Generator</Link> and the <Link
          ...
          <p>We employ the use of cookies. By accessing Twitter Toxic-bot Filter, you agreed to use cookies in agreement
              with the Ítalo Andrade's Privacy Policy.</p>
          ...
          <p>Unless otherwise stated, Ítalo Andrade and/or its licensors own the intellectual property rights for all
              material on Twitter Toxic-bot Filter. All intellectual property rights are reserved. You may access this
              from Twitter Toxic-bot Filter for your own personal use subjected to restrictions set in these terms and
              conditions.</p>

          <p>You must not:</p>
          <ul>
              <li>Republish material from Twitter Toxic-bot Filter</li>
              <li>Sell, rent or sub-license material from Twitter Toxic-bot Filter</li>
              <li>Reproduce, duplicate or copy material from Twitter Toxic-bot Filter</li>
              <li>Redistribute content from Twitter Toxic-bot Filter</li>
          </ul>

          <p>This Agreement shall begin on the date hereof.</p>

          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
              certain areas of the website. Ítalo Andrade does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views and opinions of Ítalo Andrade,its agents
              and/or affiliates. Comments reflect the views and opinions of the person who post their views and
              opinions. To the extent permitted by applicable laws, Ítalo Andrade shall not be liable for the Comments
          ...
          <p>Ítalo Andrade reserves the right to monitor all Comments and to remove any Comments which can be considered
          ...
          <p>You hereby grant Ítalo Andrade a non-exclusive license to use, reproduce, edit and authorize others to use,
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
              ...
              absence of Ítalo Andrade; and (d) the link is in the context of general resource information.</p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
              website, you must inform us by sending an e-mail to Ítalo Andrade. Please include your name, your
          ...
          <p>No use of Ítalo Andrade's logo or other artwork will be allowed for linking absent a trademark license
              agreement.</p>
